...
//	add_menu_page('Search Galleries', 'Search Galleries', 10, __FILE__, 'wp_ngg_search', plugins_url('/admin/images/nextgen_16_color.png'), 540);
	add_submenu_page('nextgen-gallery', __('Search Galleries'), __('Search Galleries'),  1, __FILE__, 'wp_ngg_search');
}
...
<div class="wrap">
 ...
 <form action="admin.php?page=ngg-search-galleries/ngg-search.php" method="post">
    <div id="search">
